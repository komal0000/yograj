...
class Helper
{
    ...
    {
        return (object)[
            'head' => self::getSetting('head_text') ?? '',
        ];
    }
    public static function getMetaSetting()
    {
        return (object)[
            'meta_title' => self::getSetting('meta_title') ?? '',
            'meta_description' => self::getSetting('meta_description') ?? '',
            'meta_image' => self::getSetting('meta_image') ?? '',
        ];
    }
